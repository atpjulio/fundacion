...
Vue.filter('moment', function (value) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_moment___default()(value).format("DD/MM/YYYY");
});
...
Vue.filter('days', function (dateFrom, dateTo) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_moment___default()(dateTo).diff(__WEBPACK_IMPORTED_MODULE_0_moment___default()(dateFrom), 'days');
});

// Components
Vue.component('invoice-component', __webpack_require__(166));
Vue.component('example-component', __webpack_require__(169));
Vue.component('puc-component', __webpack_require__(172));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['number', 'companies', 'codes', 'days', 'totals'],
    data: function data() {
        return {
            search: '',
            authorizationsTable: [],
    ...
    methods: {
        searchAuthorization: function searchAuthorization() {
            var _this = this;

            axios.post('/open-authorizations', { search: this.search }).then(function (response) {
                _this.authorizationsTable = response.data.data;
        ...
        addAuthorization: function addAuthorization(authorization) {
            this.errorSelected = '';
        ...
        removeAuthorization: function removeAuthorization(authorization) {
            this.selectedAuthorizations.splice(this.selectedAuthorizations.indexOf(authorization), 1);
        },
        updateModal: function updateModal(authorization) {
            $('#update-modal' + authorization.id).modal('show');
        },
        updateTotal: function updateTotal(event, price, id) {
            $('#service_totals' + id).val(event.target.value * price);
        },
        updateServices: function updateServices(authorization) {
            var _this2 = this;
            ...
            authorization.services.forEach(function (service) {
            ...
            axios.post('/authorization-services-update', form).then(function (response) {
                _this2.selectedAuthorizations.forEach(function (currentAuthorization) {
        ...
        loadOldValues: function loadOldValues() {
            ...
            var oldCodes = JSON.parse(this.codes);
            var oldDays = JSON.parse(this.days);
            var oldTotals = JSON.parse(this.totals);

            if (oldCodes.length > 0) {
                oldCodes.forEach(function (element, index) {
                    axios.get('/get-authorization/' + element).then(function (response) {
                        _this3.selectedAuthorizations.push(response.data);
                    }).catch(function (error) {
                        return console.log(error);
                    });
                });
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "col-12" }, [
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-block" }, [
          _c("div", { staticClass: "card-title-block" }, [
            _vm._m(0),
            _vm._v(" "),
            _c(
              "div",
              {
                staticClass:
                  "dataTables_filter float-right form-inline mb-3 mt-0"
              },
              [
                _c("label", { staticClass: "mr-2" }, [_vm._v("Buscar:")]),
                _vm._v(" "),
                _c("input", {
                  directives: [
                    {
                  ...
                  on: {
                    keydown: function($event) {
                      ...
                      return _vm.searchAuthorization()
                    },
          ...
          _c("div", { staticClass: "table-responsive" }, [
            _c(
              ...
              [
                _vm._m(1),
                _vm._v(" "),
                _vm.authorizationsTable.length > 0
                  ? _c(
                      "tbody",
                      _vm._l(_vm.authorizationsTable, function(element) {
                        return _c("tr", { key: element.id }, [
                          ...
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(_vm._s(_vm._f("moment")(element.date_from)))
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(
                          ...
                          _c("td", [
                            _c(
                              "button",
                              {
                                staticClass: "btn btn-oval btn-success",
                                attrs: { type: "button" },
                                on: {
                                  click: function($event) {
                                    return _vm.addAuthorization(element)
                                  }
                                }
                              },
                              [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "col-md-12", attrs: { id: "beginning" } }, [
      _c("div", { staticClass: "card" }, [
        _c("div", { staticClass: "card-block" }, [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-3" }, [
              _c("div", { staticClass: "form-group " }, [
                _c(
                  "label",
                  { staticClass: "control-label", attrs: { for: "number" } },
                  [_vm._v("Número de factura")]
                ),
                _vm._v(" "),
                _c("input", {
                  staticClass: "form-control underlined",
                  attrs: {
            ...
            _c("div", { staticClass: "col-md-6" }, [
              _c("div", { staticClass: "form-group " }, [
                _c(
                  ...
                  [_vm._v("Compañía a la que pertenece la factura")]
                ),
                _vm._v(" "),
                _c(
                  "select",
                  {
                    ...
                    attrs: { id: "company_id", name: "company_id" }
                  },
                  _vm._l(JSON.parse(this.companies), function(company) {
                    return _c(
                      "option",
            ...
            _c("div", { staticClass: "table-responsive" }, [
              _c(
                "table",
                {
                  ...
                  attrs: { id: "multiple_table" }
                },
                [
                  _vm._m(3),
                  _vm._v(" "),
                  _vm.selectedAuthorizations.length > 0
                    ? _c(
                        "tbody",
                        _vm._l(_vm.selectedAuthorizations, function(
                          authorization
                        ) {
                          return _c("tr", { key: authorization.id }, [
                            _c("td", { staticClass: "pt-3" }, [
                              _vm._v(
                                "\n                                        " +
                                  _vm._s(authorization.code) +
                                  "\n                                        "
                              ),
                              _c("input", {
                                attrs: {
                                ...
                                domProps: { value: authorization.code }
                              })
                            ]),
                            _vm._v(" "),
                            _c(
                              ...
                              { staticClass: "pt-3" },
                              [
                                _vm._l(authorization.services, function(
                                  service
                                ) {
                                  return _c("div", { key: service.id }, [
                                    _vm._v(
                                      "\n                                            " +
                                        _vm._s(service.service.code) +
                                        " - " +
                                ...
                                _c("input", {
                                  ...
                                  domProps: {
                                    value: authorization.services[0].price
                                  }
                                })
                              ],
                              2
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c("input", {
                                  ...
                                  domProps: {
                                    value: authorization.services[0].days
                                  }
                                })
                              ],
                              2
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c("input", {
                                  attrs: {
                                    type: "hidden",
                                    name: "multiple_totals[]",
                                    id: "multiple_totals" + authorization.id
                                  },
                                  domProps: {
                                    value:
                                      authorization.services[0].days *
                                      parseInt(authorization.services[0].price)
                                  }
                                })
                              ],
                              2
                            ...
                            _c("td", [
                              _c(
                                "button",
                                {
                                  staticClass: "btn btn-oval btn-danger",
                                  attrs: { type: "button" },
                                  on: {
                                    click: function($event) {
                              ...
                              _c(
                                "button",
                                {
                                  staticClass: "btn btn-oval btn-secondary",
                                  attrs: { type: "button" },
                                  on: {
                                    click: function($event) {
                                      return _vm.updateModal(authorization)
                                    }
                                  }
                                },
                                [
                            ...
                            _c(
                              "div",
                              {
                                ...
                                attrs: {
                                  id: "update-modal" + authorization.id,
                                  tabindex: "-1",
                                  role: "dialog",
  ...
  function() {
    ...
    return _c("div", { staticClass: "float-left" }, [
      _c("h3", { staticClass: "title" }, [
        _vm._v(" Autorización para esta factura")
      ])
    ])
  },
  function() {
  ...
  function() {
    ...
    return _c("tr", [
      _c("td", { staticClass: "text-center", attrs: { colspan: "6" } }, [
        _vm._v("No hay resultados que mostrar")
      ])
    ])
  },
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", [_vm._v("Autorización")]),
        _vm._v(" "),
        _c("th", [_vm._v("Servicios")]),
        _vm._v(" "),
        _c("th", { staticStyle: { width: "100px" } }, [_vm._v("Días")]),
        _vm._v(" "),
        _c("th", [_vm._v("Total")]),
        _vm._v(" "),
...
Component.options.__file = "resources/assets/js/components/PucComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-95b59c54", Component.options)
  } else {
    hotAPI.reload("data-v-95b59c54", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getPucs: function getPucs() {
            var _this = this;

            axios.get('/api/pucs').then(function (data) {
                _this.pucs = data.data;
            }).catch(function () {
                return console.log('Some error on pucs');
            });
        },
        addPuc: function addPuc() {
            this.addTableError = '';
            if (this.invalidData()) {
        ...
        resetAddTable: function resetAddTable() {
            this.addTable = {
                code: '',
                description: '',
                debit: 0,
  ...
  return _c("div", [
    _vm.pucs.length > 0
      ? _c("div", { staticClass: "form-group" }, [
          _c(
            "label",
            { staticClass: "control-label", attrs: { for: "pucs" } },
            [_vm._v("Listado de códigos PUC")]
          ),
          _vm._v(" "),
          _c(
            "select",
            {
              ...
              on: {
                change: function($event) {
                  return _vm.updateAddTable($event)
                }
              }
            },
            [
              _c("option", [_vm._v("Seleccione el código PUC")]),
              _vm._v(" "),
              _vm._l(_vm.pucs, function(puc) {
                return _c(
                  "option",
                  { key: puc.code, domProps: { value: puc.code } },
                  [
                    _vm._v(
                      "\n                " +
                        _vm._s(puc.code) +
                        " - " +
                        _vm._s(puc.description) +
                        "\n            "
                    )
                  ]
                )
    ...
    _c("div", { staticClass: "form-group" }, [
      _c("div", { staticClass: "row" }, [
              ...
              _c("tr", [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addTable.code,
                        expression: "addTable.code"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "text", placeholder: "Código PUC" },
                    domProps: { value: _vm.addTable.code },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.addTable, "code", $event.target.value)
                      }
                    }
                  })
                ]),
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addTable.description,
                        expression: "addTable.description"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "text", placeholder: "Descripción" },
                    domProps: { value: _vm.addTable.description },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addTable.debit,
                        expression: "addTable.debit"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "number", min: "0", placeholder: "Débitos" },
                    domProps: { value: _vm.addTable.debit },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.addTable, "debit", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("td", [
                  _c("input", {
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.addTable.credit,
                        expression: "addTable.credit"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: {
                    ...
                    domProps: { value: _vm.addTable.credit },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.addTable, "credit", $event.target.value)
                      }
                    }
                  })
                ]),
                ...
                _c("td", [
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-oval btn-info",
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          return _vm.addPuc($event)
                        }
                      }
                    },
                    [_vm._v("Añadir")]
        ...
        _vm._v(" "),
        _c("div", { staticClass: "col-md-6 text-danger" }, [
          _vm._v(_vm._s(_vm.addTableError))
        ]),
        _vm._v(" "),
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", { staticClass: "control-label", attrs: { for: "pucs" } }, [
        _vm._v("Códigos PUC del comprobante")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12" }, [
                    ...
                    return _c("tr", [
                        ...
                        _c("input", {
                          ...
                          on: {
                            input: function($event) {
                              ...
                              _vm.$set(element, "code", $event.target.value)
                            }
                          }
                        })
                      ]),
                      ...
                      _c("td", [
                        _c("input", {
                          ...
                          domProps: { value: element.description },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                        ...
                        _c("input", {
                          ...
                          on: {
                            ...
                            input: function($event) {
                              ...
                              _vm.$set(element, "debit", $event.target.value)
                            }
                          }
                        })
                      ]),
                        ...
                        _c("input", {
                          ...
                          on: {
                            ...
                            input: function($event) {
                              ...
                              _vm.$set(element, "credit", $event.target.value)
                            }
                          }
                        })
                      ]),
        ...
        _c("div", { staticClass: "col-12 text-danger" }, [
          _vm._v(_vm._s(_vm.pucTableError))
        ])
      ])
    ])
  ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticStyle: { width: "135px !important" } }, [
          _vm._v("Código")
        ]),
        _vm._v(" "),
        _c("th", {}, [_vm._v("Descripción")]),
        _vm._v(" "),
        _c("th", { staticStyle: { width: "150px !important" } }, [
          _vm._v("Débitos")
        ]),
        _vm._v(" "),
        _c("th", { staticStyle: { width: "150px !important" } }, [
        ...
        _vm._v(" "),
        _c("th", { staticStyle: { width: "85px !important" } }, [
          _vm._v("Acción")
        ])
      ])
    ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-95b59c54", module.exports)
  }
}
