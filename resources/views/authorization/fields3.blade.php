        ...
        <table class="table table-hover table-bordered" id="companionsTable">
          ...
          <tbody>
            @foreach (Request::input('companionDni') as $k => $val)
              <tr>
                <td>
                  <input type="text" id="companionDni" name="companionDni[]" value="{{ $val }}"
                    class="form-control" placeholder="Número de Documento" readonly />
                </td>
                <td>
                  <input type="text" id="companionService" name="companionService[]" class="form-control"
                    placeholder="Servicio para el acompañante" readonly
                    value="{{ Request::input('companionService')[$k] }}" />
                  <input type="hidden" name="companionServiceId[]" id="companionServiceId"
                    value="{{ Request::input('companionServiceId')[$k] }}">
                </td>
              </tr>
            @endforeach
          </tbody>
...
@else
  @if (!isset($show))
    <div class="form-group">
      <label for="companion_services" class="control-label">Seleccione el servicio que aplica al acompañante</label>
      <div class="row">
        @php
  ...
  <div class="form-group">
    <div class="table-responsive">
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          <tr>
            <td>
              <input type="text" id="companion_document" name="companion_document" class="form-control"
                placeholder="Número de Documento" />
            </td>
            <td>
              <input type="text" id="companion_service" name="companion_service" class="form-control"
                placeholder="Servicio para el acompañante" readonly />
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert"
      style="background-color: #ffffff !important; color: #dd4b39 !important; display: none;" id="alertTable">
          ...
          @if (isset($authorization) and $authorization->companion_dni)
            ...
            @foreach (explode(',', $authorization->companion_dni) as $k => $val)
              ...
              <tr>
                ...
                <td>
                  <input type="text" id="companionService" name="companionService[]" class="form-control"
                    placeholder="Servicio para el acompañante" readonly value="{{ $sc->name }}" />
