<div class="card">
    <div class="card-block">
        ...
        <div class="form-group  @if($errors->has('companion')) has-error @endif">
            ...
            $authorization->companion : ''), ['class' => 'form-control', isset($show) ? 'disabled' : '', 'id' =>
            'companion']) !!}
        </div>
        <div id="companionsDiv" @if (old('companion') or (isset($authorization) and $authorization->companion))
            style="display: block;"
            @else
            style="display: none;"
            @endif>
        ...
        <div class="form-group" id="multipleServicesDiv" @if (old('multiple_services') || (isset($authorization) and
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="javascript:void(0);"
                                    class="removeRowService btn btn-oval btn-danger">Quitar</a></td>
                        </tr>
                        @endforeach
