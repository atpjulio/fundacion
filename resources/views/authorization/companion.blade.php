...
<div class="form-group  @if($errors->has('companion_phone')) has-error @endif">
    {!! Form::label('companion_phone', 'Número de contacto del acompañante', ['class' => 'control-label']) !!}
    {!! Form::text('companion_phone', old('companion_phone', isset($authorization) ? $authorization->companion_phone : ''), ['class' => 'form-control underlined', 'placeholder' => 'Número de contacto (opcional)', 'maxlength' => 15]) !!}
</div>
