  ...
  <div class="card">
    <div class="card-block">
      <div class="form-group  @if ($errors->has('created_at')) has-error @endif">
        ...
        <input type="date" name="created_at" placeholder="dd/mm/aaaa" class="form-control underlined" value="{{ old('created_at', isset($egress) ? $egress->created_at : now()) }}">
      </div>
      ...
      <div class="form-group @if ($errors->has('concept')) has-error @endif">
        ...
        <textarea name="concept" class="form-control underlined" placeholder="Concepto" rows="4">
          {{ old('concept', isset($egress) ? $egress->concept : '') }}
        </textarea>
      </div>
    </div>
  </div>
