...
@section('content')
    <div class="title-block">
        <div class="float-left">
            ...
            <p class="title-description"> Generar volumen de comprobante de egresos para un mes </p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="text-center">
                    {!! Form::submit('Generar Comprobantes del Mes', ['class' => 'btn btn-oval btn-primary']) !!}
                </div>
            </div>
        </div>
    </section>
