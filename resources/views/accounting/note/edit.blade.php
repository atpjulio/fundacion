...
@section('content')
    <div class="title-block">
        <div class="float-left">
            <h3 class="title"> Editar Nota de Contabilidad </h3>
            <p class="title-description"> Actualizando nota de contabilidad del sistema </p>
        </div>
                ...
                <div class="card">
                    <div class="card-block">
                        <div class="card-title-block">
                            <h3 class="title"> Factura seleccionada para esta nota de contabilidad </h3>
                        </div>
                        <div class="col-12">
        ...
        $(document).ready(function() {
            ...
            $('#myTable').DataTable({
                "language": {
                    ...
                    "oSearch": {"sSearch": "{{ $note->invoice->number }}"}                    
                }
            });
