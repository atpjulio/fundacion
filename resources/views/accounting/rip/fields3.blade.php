...
<div class="form-group @if ($errors->first('notePucs.*')) has-error @endif">
  <label for="notePucs" class="control-label">Códigos PUC de la nota de contabilidad</label>
  <div class="row">
    <div class="col-12">
