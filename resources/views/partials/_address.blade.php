...
<div class="form-group  @if ($errors->has('line1')) has-error @endif">
  ...
  <input type="text" class="form-control underlined" name="line1" maxlength="50" placeholder="Dirección"
    value="{{ old('line1', isset($address) ? $address->line1 : '') }}">
</div>

<div class="form-group  @if ($errors->has('line2')) has-error @endif">
  <label for="line2" class="control-label">Dirección (continuación - opcional)</label>
  <input type="text" class="form-control underlined" name="line2" maxlength="50"
    placeholder="Continuación de la dirección" value="{{ old('line2', isset($line2) ? $address->line2 : '') }}">
</div>
